...
export const metadata: Metadata = {
  title: "Oddyssey — Immersive Nightlife at AREA15",
  description:
...
// same .oddyssey-scope CSS variables (--bg, --text, --accent, --serif,
// etc.) when rendered under /oddyssey. Without this scope, Content
// renders with browser defaults (the colors-off bug Keith caught).
