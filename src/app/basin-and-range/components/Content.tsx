...
function Nav() {
  return (
    <header className="fixed top-0 w-full z-50 flex justify-between items-center px-6 md:px-12 py-6 md:py-8 bg-surface/80 backdrop-blur-sm">
      <div className="text-xl md:text-2xl font-black font-headline tracking-tighter text-on-surface">
        Basin &amp; Range
      </div>
      <nav className="hidden md:flex items-center space-x-12">
        <a
          href="#route"
          className="font-headline uppercase tracking-[0.2em] font-bold text-sm text-primary border-b-2 border-primary pb-1"
        >
          The Route
        </a>
        <a
          href="#map"
          className="font-headline uppercase tracking-[0.2em] font-bold text-sm text-on-surface hover:text-primary transition-colors duration-300"
        >
          Map
        </a>
        <a
      ...
      <a
        href="mailto:hello@basinandrange100.com"
        className="font-headline uppercase tracking-[0.2em] font-bold text-sm px-8 py-3 bg-primary text-on-primary hover:brightness-110 transition-all hidden md:block"
      >
        Get in Touch
      </a>
    </header>
  ...
  return (
    <section className="relative min-h-screen flex items-center px-6 md:px-12 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl pt-20">
        ...
        <p className="font-headline tracking-[0.3em] text-xl md:text-2xl mb-4 text-on-surface-variant uppercase">
          100 Mile Desert Ultra
        </p>
        <p className="font-headline tracking-[0.2em] text-sm md:text-base mb-12 text-outline uppercase">
          Red Rock Canyon &rarr; Henderson &rarr; Boulder City
        </p>
        <div className="flex flex-col md:flex-row gap-6">
          <a
            href="#route"
            className="bg-primary text-on-primary px-12 py-5 font-bold tracking-widest text-sm uppercase hover:brightness-110 transition-all text-center"
          >
            View the Route
          </a>
          <a
            href="#map"
            className="border border-primary/30 text-primary px-12 py-5 font-bold tracking-widest text-sm uppercase hover:bg-primary/10 transition-colors text-center"
          >
            Explore Map
          </a>
        </div>
  ...
  return (
    <section className="py-32 px-6 md:px-12 bg-surface">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
        <div>
          <h2 className="text-primary text-sm tracking-[0.4em] font-bold font-headline mb-2">
            Concept Overview
          </h2>
          <div className="w-12 h-1 bg-primary mb-8" />
          <p className="text-3xl md:text-5xl font-light leading-snug text-on-surface-variant">
        ...
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            <div
              key={stat.label}
              className="bg-surface-container p-8 md:p-10 flex flex-col justify-between aspect-square border-l-4 border-primary"
            >
              <span className="text-primary text-5xl md:text-6xl font-black font-headline">
                {stat.value}
                {stat.unit && (
                  <span className="text-xl font-normal text-outline ml-1">
                    {stat.unit}
                  </span>
                )}
              </span>
...
function RoutePhases() {
  return (
    <section id="route" className="py-32 bg-surface-lowest scroll-mt-20">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <h2 className="text-center text-4xl md:text-6xl font-black font-headline mb-4 tracking-tighter">
          The Phases
        </h2>
        <div className="w-12 h-1 bg-primary mx-auto mb-24" />

        <div className="space-y-px bg-outline-variant/10">
          {phases.map((phase, i) => (
            <div
              key={i}
              className="group flex flex-col md:flex-row justify-between items-start md:items-center bg-surface-container p-8 md:p-12 hover:bg-surface-high transition-all duration-500 border-l-4 border-transparent hover:border-primary"
            >
              <div className="flex items-start md:items-center gap-8 md:gap-12">
                <span className="text-5xl md:text-6xl font-black font-headline text-surface-highest group-hover:text-primary transition-colors duration-300">
                ...
                <div>
                  ...
                  <p className="text-outline text-xs tracking-widest mt-2 uppercase">
                    {phase.surface}
                  </p>
                  <p className="text-sm text-secondary leading-relaxed mt-4 max-w-xl hidden md:block">
                    {phase.description}
                  </p>
                  <ul className="mt-3 space-y-1 hidden lg:block">
                    {phase.trails.map((trail, j) => (
                      <li
                        key={j}
                        className="text-outline text-xs tracking-wide"
                      >
                        {trail}
                      </li>
                    ))}
              ...
              <div className="mt-4 md:mt-0 md:text-right shrink-0">
                <div className="text-primary font-black font-headline text-xl">
                  {phase.miles} mi
                </div>
                <div className="text-[10px] tracking-widest text-outline uppercase mt-1">
                  {phase.label}
                </div>
              </div>
            </div>
  ...
  return (
    <section className="py-32 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-sm tracking-[0.5em] font-bold font-headline text-primary mb-2 text-center">
          Surface Architecture
        </h2>
        <div className="w-12 h-1 bg-primary mx-auto mb-16" />
        ...
        <div className="space-y-10">
          {surfaceBreakdown.map((s, i) => (
            <div key={s.label}>
              ...
              <div className="h-4 bg-surface-highest">
                <div
                  className={`h-full ${
                    i === 0
                      ? "bg-primary"
  ...
  return (
    <section className="py-32 bg-surface-lowest relative">
      <div className="max-w-5xl mx-auto px-6 md:px-12 relative">
        {/* Center line */}
        <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-outline-variant/30 md:-translate-x-1/2" />
        ...
        <div className="space-y-32 md:space-y-40">
          {courseStory.map((stage, i) => (
            ...
            >
              {/* Square marker */}
              <div className="absolute left-[18px] md:left-1/2 md:-translate-x-1/2 w-[9px] h-[9px] bg-primary z-10 hidden md:block" />
              <div className="absolute left-[20px] top-[5px] w-[9px] h-[9px] bg-primary md:hidden" />
              ...
              >
                ...
                <p className="text-primary text-[10px] tracking-[0.3em] font-bold uppercase mb-3">
                  {stage.label}
                </p>
...
function MapSection() {
  return (
    <section id="map" className="py-32 px-6 md:px-12 bg-surface scroll-mt-20">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center text-4xl md:text-6xl font-black font-headline mb-4 tracking-tighter">
          The Corridor
        </h2>
        ...
        <div className="border border-primary/10 p-1 bg-surface-low relative overflow-hidden">
        ...
        <p className="text-outline text-[10px] tracking-widest uppercase font-bold mt-8 text-center">
...
function Experience() {
  ...
  return (
    <section id="vision" className="py-32 scroll-mt-20">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-outline-variant/10">
        {points.map((p) => (
          <div
            key={p.title}
            className="bg-surface-container p-12 hover:bg-primary/5 transition-colors"
          >
            <h4 className="text-primary font-black font-headline mb-4">
              {p.title}
            </h4>
  ...
  return (
    <section className="py-32 bg-surface-lowest">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="bg-surface-highest border-t-2 border-primary p-8 md:p-12 mb-24">
          <h3 className="font-headline font-black uppercase tracking-widest text-lg mb-4">
            The Boulder City Finish
          </h3>
          <p className="text-sm text-secondary leading-relaxed mb-6 max-w-2xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
          <div className="space-y-16">
            {left.map((el) => (
              <div key={el.title}>
                <h3 className="text-primary text-2xl md:text-3xl font-black font-headline mb-4">
                  {el.title}
                </h3>
  ...
  return (
    <section className="py-20 bg-surface">
      <div className="max-w-3xl mx-auto px-6 text-center">
        <p className="text-outline text-[10px] tracking-[0.2em] uppercase font-bold leading-loose">
    ...
    <section className="relative py-32 md:py-48 px-6 md:px-12 flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center">
          <a
            href="mailto:hello@basinandrange100.com"
            className="bg-primary text-on-primary px-8 md:px-16 py-5 md:py-6 font-black tracking-widest text-sm md:text-lg uppercase hover:brightness-110 transition-all"
          >
            Get in Touch
          </a>
          <a
            href="#route"
            className="border border-on-surface/20 text-on-surface px-8 md:px-16 py-5 md:py-6 font-black tracking-widest text-sm md:text-lg uppercase hover:bg-on-surface/5 transition-colors"
          >
            Review the Route
          </a>
        </div>
...
function Footer() {
  return (
    <footer className="w-full px-6 md:px-12 py-20 flex flex-col md:flex-row justify-between items-center gap-8 bg-surface-lowest border-t border-surface-highest/10">
      <span className="font-headline font-bold text-primary text-2xl tracking-[0.3em]">
        BASIN &amp; RANGE
      </span>
      <nav className="flex flex-col md:flex-row items-center gap-4 md:gap-12">
        <a
          href="#route"
          className="uppercase tracking-[0.2em] text-[10px] font-medium text-secondary/50 hover:text-primary transition-colors"
        >
          Route
        </a>
        <a
      ...
      <p className="uppercase tracking-[0.2em] text-[10px] font-medium text-secondary/50 text-center">
