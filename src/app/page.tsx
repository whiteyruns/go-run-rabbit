      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0a0a0e]/60 backdrop-blur-xl">
        <div className="flex justify-between items-center px-8 py-4 max-w-7xl mx-auto">
          <Link href="/" className="hover:opacity-80 transition-opacity">
            <img src="/grr-icon.png" alt="Go Run Rabbit" className="h-10 brightness-0 invert" />
          </Link>
      ...
      <footer className="border-t border-[#48474b]/20">
        <div className="max-w-7xl mx-auto py-12 px-8">
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-8">
            <div>
              <img src="/grr-wordmark.png" alt="Go Run Rabbit" className="h-8 mb-2 brightness-0 invert" />
