...
const PUBLIC_PATHS = ["/", "/login", "/pitch", "/basin-and-range", "/apache-springs", "/canyon-expedition", "/oddyssey-manor", "/corner-bar-management", "/efd-outbound-overview", "/doberman-outreach", "/feed-the-block", "/tsp-trk", "/api/auth/login"];
