  ...
  return (
    <div style={{ background: "#060606", color: "#e8e4dd" }}>
      ...
      <div className="sw-page">
        ...
        <div className="sw-top-bar no-print">
          <button className="sw-pdf-btn" onClick={() => window.print()}>
...
/* PDF Button */
.sw-top-bar { display: flex; justify-content: flex-end; margin-bottom: 20px; }
.sw-pdf-btn {
...
.sw-pdf-btn:hover { color: #c9a84c; border-color: rgba(201,168,76,0.3); }
...
@media print {
  ...
  .sw-page, .sw-header, .sw-section,
  .sw-swot-grid, .sw-swot-card, .sw-cross-grid, .sw-cross-card,
  .sw-forces, .sw-force, .sw-force-critical, .sw-overall, .sw-overall-score,
  .sw-overall-text, .sw-forces-table { background: #fff !important; color: #111 !important; }

  .sw-page { padding: 20px 40px; max-width: none; }
  .no-print, .sw-back, .sw-footer { display: none !important; }

  .sw-header { padding-bottom: 24px; margin-bottom: 24px; border-bottom: 2px solid #111; }
  .sw-logo { filter: invert(1); height: 36px; }
  .sw-label { color: #333 !important; }
  .sw-header h1 { color: #111 !important; font-size: 36px; }
  .sw-subtitle { color: #555 !important; }
  .sw-meta { color: #888 !important; }

  .sw-section { margin-bottom: 28px; }
  .sw-section-title { color: #111 !important; font-size: 18px; border-bottom: 2px solid #111; margin-bottom: 16px; padding-bottom: 8px; }

  .sw-swot-grid { background: #fff !important; gap: 0 !important; border: 1px solid #ccc; }
  .sw-swot-card { background: #fff !important; border-bottom: 1px solid #eee; }
  .sw-swot-card h3 { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
  .sw-strengths h3 { color: #27ae60 !important; border-color: #27ae60 !important; }
  .sw-weaknesses h3 { color: #c0392b !important; border-color: #c0392b !important; }
  .sw-opportunities h3 { color: #3498db !important; border-color: #3498db !important; }
  .sw-threats h3 { color: #f39c12 !important; border-color: #f39c12 !important; }
  .sw-swot-card li { color: #333 !important; border-color: #eee !important; }
  .sw-swot-card strong { color: #000 !important; }

  .sw-cross-grid { background: #fff !important; gap: 0 !important; border: 1px solid #ccc; }
  .sw-cross-card { background: #fff !important; border-bottom: 1px solid #eee; }
  .sw-cross-card h4 { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
  .sw-cross-so h4 { color: #27ae60 !important; }
  .sw-cross-wt h4 { color: #c0392b !important; }
  .sw-cross-card h4 span { color: #888 !important; }
  .sw-cross-card li { color: #333 !important; border-color: #eee !important; }
  .sw-cross-so li::before { border-color: #27ae60 !important; }
  .sw-cross-wt li::before { border-color: #c0392b !important; }

  .sw-force { background: #f5f5f5 !important; border: 1px solid #ccc !important; }
  .sw-force h4 { color: #111 !important; }
  .sw-force > p { color: #333 !important; }
  .sw-rating-bar { background: #ddd !important; }
  .sw-rating-fill { background: #333 !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
  .sw-rating-num { color: #111 !important; }
  .sw-rating-level { color: #555 !important; }
  .sw-force-critical { background: #fff !important; border-color: #ccc !important; }
  .sw-force-critical strong { color: #111 !important; }

  .sw-overall { background: #fff !important; gap: 0 !important; border: 1px solid #ccc; }
  .sw-overall-score { background: #f5f5f5 !important; }
  .sw-overall-num { color: #111 !important; }
  .sw-overall-label { color: #555 !important; }
  .sw-overall-text { background: #fff !important; }
  .sw-overall-text p { color: #333 !important; }
  .sw-overall-text strong { color: #000 !important; }

  .sw-forces-table table { border: 1px solid #ccc; }
  .sw-forces-table th { color: #555 !important; border-color: #ccc !important; }
  .sw-forces-table td { color: #333 !important; border-color: #ddd !important; }
  .sw-forces-table strong { color: #000 !important; }
}
`;
