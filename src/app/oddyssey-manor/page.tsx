...
import OddysseyContent from "./components/Content";

const ACCESS_CODE = "oddyssey2026";

export default function OddysseyManorPage() {
  ...
  return (
    ...
    >
      <div
        ...
        style={{ animation: "odFadeIn 1s ease-out" }}
      >
        <style>{`
          @keyframes odFadeIn {
        ...
        <p
          ...
          style={{ color: "#c9a84c", fontWeight: 500, letterSpacing: "4px" }}
        >
          Website Optimization
        </p>
        <p
          className="uppercase tracking-[0.2em] text-xs mb-12"
          style={{ color: "#5a5650" }}
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-4 text-xs uppercase tracking-widest font-medium transition-all"
            style={{
              background: "#c9a84c",
              color: "#060606",
              letterSpacing: "3px",
