          ...
          <table className="audit-table">
            ...
            <tbody>
              {[
                ...
                { n: 8, finding: <><strong>No private events page</strong> &mdash; no group booking, bachelorette packages, bottle service menu, or corporate inquiry form. Standard for LV venues, currently absent.</>, priority: "medium", impact: "Revenue per visit, group sales" },
                { n: 9, finding: <><strong>Dead blog / no content engine</strong> &mdash; 3 posts from January, nothing since. No event recaps, artist spotlights, or SEO-building content.</>, priority: "medium", impact: "Organic search, credibility" },
                { n: 10, finding: <><strong>Weak search visibility</strong> &mdash; no keyword-optimized copy targeting &ldquo;Las Vegas house music,&rdquo; &ldquo;AREA15 nightlife,&rdquo; or &ldquo;immersive nightclub Las Vegas.&rdquo;</>, priority: "medium", impact: "Organic discovery" },
              ].map(row => (
                <tr key={row.n}>
                  <td>{row.n}</td>
                  <td>{row.finding}</td>
